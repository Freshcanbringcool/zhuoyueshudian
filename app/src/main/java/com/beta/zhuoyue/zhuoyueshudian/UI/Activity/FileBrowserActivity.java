...
import com.beta.zhuoyue.zhuoyueshudian.Model.SubFile;
...
public class FileBrowserActivity extends Activity {
    ...
    private class OnItemClick implements AdapterView.OnItemClickListener{
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            if(subFile.getFile().isDirectory()){//如果路径为文件夹
                ...
                intent = new Intent(FileBrowserActivity.this,FirstFragmentActivity.class);//跳转到主界面
                intent.putExtra("id",2);//按照0,1,2,4,来分配Fragment的页面返回的时候就是根据这个id进行返回
    ...
    public void writeData(String str){
        File file = new File(BookCaseFragment.MYPATH+File.separator+"bookPath.txt");//要操作的文件
        try {
